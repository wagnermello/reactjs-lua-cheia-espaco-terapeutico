...
function Atendimentos() {
	return (
		<section className="atendimentos app__wrapper">
			<div className="atendimentos__container container__wrapper flex__column__center gap__y32">
				<motion.div
				...
				<div className="atendimentos__container__images flex__row__center gap__x64">
					<motion.div
