...
function Atendimentos() {
	return (
		<section className="atendimentos app__wrapper flex__center__column">
			<motion.div
			...
			<div className="flex__center__row">
				<motion.div
			...
			>
				...
				<p className="p-text-purple">Confira abaixo os nossos atendimentos:</p>
			</motion.div>
		</section>
	);
}
